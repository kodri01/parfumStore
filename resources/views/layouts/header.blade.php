    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            @role(['administrator'])
                ...
                <li class="nav-item  <?php if ($title == 'Categori') {
                    echo 'active';
                } ?>">
                ...
                <li class="nav-item <?php if ($title == 'Parfum - Stok Parfum' || $title == 'Parfum - Parfum Masuk' || $title == 'Parfum - Purchase Order' || $title == 'Parfum - Details Order' || $title == 'Parfum - Parfum Keluar') {
                    echo 'active';
                } ?>">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                        aria-expanded="true" aria-controls="collapseTwo">
                        <i class="fas fa-fw fa-box"></i>
                        <span>Manage Parfum</span>
                    </a>
                    <div class="collapse " id="collapseTwo" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item <?php if ($title == 'Parfum - Stok Parfum') {
                                echo 'active';
                            } ?>" href="{{ route('product') }}">Stok Parfum</a>
                            <a class="collapse-item <?php if ($title == 'Parfum - Parfum Masuk') {
                                echo 'active';
                            } ?>" href="{{ route('product.masuk') }}">Parfum
                                Masuk</a>
                            <a class="collapse-item <?php if ($title == 'Parfum - Parfum Keluar') {
                                echo 'active';
                            } ?>" href="{{ route('product.keluar') }}">Parfum
                                Keluar</a>
                            <a class="collapse-item <?php if ($title == 'Parfum - Purchase Order' || $title == 'Parfum - Details Order') {
                                echo 'active';
                ...
                <li class="nav-item  <?php if ($title == 'Pengeluaran') {
                    echo 'active';
                } ?>">
                ...
                <li class="nav-item <?php if ($title == 'Laporan - Neraca' || $title == 'Laporan - Laba Rugi' || $title == 'Laporan - Perubahan Modal') {
                    ...
                    <div class="collapse " id="collapse4" aria-labelledby="heading1" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
